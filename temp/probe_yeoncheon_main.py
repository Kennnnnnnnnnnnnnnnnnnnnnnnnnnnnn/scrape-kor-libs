"""
연천군도서관(library.yeoncheon.go.kr) GNB 및 검색 폼 분석
"""
import requests
...
url = "https://library.yeoncheon.go.kr"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("yeoncheon_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved yeoncheon_main.html")
