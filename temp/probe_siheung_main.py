"""
시흥시도서관(lib.siheung.go.kr) GNB 및 검색 폼 분석
"""
import requests
...
url = "https://lib.siheung.go.kr"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("siheung_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved siheung_main.html")
