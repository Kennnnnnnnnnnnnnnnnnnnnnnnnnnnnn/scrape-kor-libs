"""
안성시도서관 상세페이지(searchView.do) 기반 청구기호/소장처 검증
"""
import requests
...
# biblioId 가 845044 인 도서 상세페이지 찌르기
params = {
    "mId": "0101010100",
    "biblioId": "845044"
}
...
try:
    ...
    with open("anseong_detail.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved anseong_detail.html")
