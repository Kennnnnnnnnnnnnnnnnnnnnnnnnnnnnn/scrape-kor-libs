"""
연천군도서관 EUC-KR 한글 인코딩 및 지점코드 병합 통합검색 실시간 검증
"""
import requests
import urllib.parse
...
# url 및 파라미터 조립
base_url = "https://library.yeoncheon.go.kr/menu/10039/program/30005/searchResultList.do"

# 다중 searchLibraryArr 매개변수를 문자열 포맷으로 수동 조립!
...
try:
    ...
    with open("yeoncheon_real_euckr_libs_result.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved yeoncheon_real_euckr_libs_result.html")
