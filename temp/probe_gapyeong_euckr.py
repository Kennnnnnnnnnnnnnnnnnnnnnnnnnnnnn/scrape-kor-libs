"""
가평군도서관 한글 EUC-KR 수동 인코딩 검색 실시간 검증
"""
import requests
import urllib.parse
...
url = f"http://www.gaplib.go.kr/intro/menu/10035/program/30005/searchResultList.do?searchLibraryArr=&searchKeyword={kwd_enc}&searchType=SIMPLE&searchCategory=ALL&searchKey=ALL"
...
try:
    ...
    with open("gapyeong_real_euckr_result.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved gapyeong_real_euckr_result.html")
