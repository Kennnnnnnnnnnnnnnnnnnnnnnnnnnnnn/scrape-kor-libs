"""
여주시도서관(yjlib.go.kr) 메인 및 검색 폼 분석
"""
import requests
...
url = "https://www.yjlib.go.kr"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("yeoju_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved yeoju_main.html")
