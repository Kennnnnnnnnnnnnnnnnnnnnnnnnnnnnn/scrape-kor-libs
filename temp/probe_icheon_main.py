"""
이천시도서관(icheonlib.go.kr) 메인 및 검색 폼 분석
"""
import requests
...
url = "https://www.icheonlib.go.kr"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("icheon_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved icheon_main.html")
