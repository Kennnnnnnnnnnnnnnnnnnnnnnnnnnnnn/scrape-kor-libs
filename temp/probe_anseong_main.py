"""
안성시도서관(anseong.go.kr/library/main.do) GNB 및 검색 폼 분석
"""
import requests
...
url = "https://www.anseong.go.kr/library/main.do"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("anseong_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved anseong_main.html")
