"""
양주시도서관(libyj.go.kr) 메인 및 검색 폼 분석
"""
import requests
...
url = "https://www.libyj.go.kr"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("yangju_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved yangju_main.html")
