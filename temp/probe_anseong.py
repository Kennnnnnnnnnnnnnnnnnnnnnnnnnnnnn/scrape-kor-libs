"""
안성시립도서관(anseong.go.kr/library) 통합검색 분석 스크립트
"""
import requests
...
print("=== 1. 안성시 도서관 메인 페이지 분석 ===")
try:
    r = session.get("https://www.anseong.go.kr/library/index.do", headers=HEADERS, timeout=8, verify=False)
...
# 2. 대표 JNET / KOLASEEK 엔드포인트 테스트
print("\n=== 2. 엔드포인트 테스트 ===")
test_urls = [
    "https://www.anseong.go.kr/library/search/resultList.do",
    "https://www.anseong.go.kr/library/program/searchResultList.do",
    "https://www.anseong.go.kr/library/kolaseek/search/searchResultList.do"
]
