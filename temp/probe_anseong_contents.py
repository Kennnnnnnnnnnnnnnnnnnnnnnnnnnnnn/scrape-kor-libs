"""
안성시도서관 통합검색 서비스 페이지(/library/contents.do?mId=0101010000) 본문 상세 분석
"""
import requests
...
url = "https://www.anseong.go.kr/library/contents.do?mId=0101010000"
...
try:
    ...
    with open("anseong_contents.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved anseong_contents.html")
