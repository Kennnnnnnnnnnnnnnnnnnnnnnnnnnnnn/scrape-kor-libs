"""
가평군도서관(gaplib.go.kr) GNB 및 검색 폼 분석
"""
import requests
...
url = "http://www.gaplib.go.kr"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("gapyeong_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved gapyeong_main.html")
