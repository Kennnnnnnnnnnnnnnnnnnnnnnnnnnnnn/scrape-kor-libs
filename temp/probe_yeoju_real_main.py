"""
여주시도서관 진짜 메인(/web/index.do) GNB 및 검색 폼 식별
"""
import requests
...
url = "https://www.yjlib.go.kr/web/index.do"

try:
    r = session.get(url, headers=HEADERS, timeout=8, verify=False)
    print("Status:", r.status_code)
    
    with open("yeoju_real_main.html", "w", encoding="utf-8") as f:
        f.write(r.text)
    print("Saved yeoju_real_main.html")
